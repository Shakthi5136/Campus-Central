		...
		<div class="wrapper" style="background-color:#102e7ce6;">
			<div class="inner">
				...
				<form action="stafflogin" method="post">
					...
					<div class="form-wrapper">
						<input type="text" class="form-control"  name="staff" placeholder="Enter ID"  >    
						<i class="zmdi zmdi-star zmdi-hc-fw"></i>
					</div>
					
					<div class="form-wrapper">
<input type="password" class="form-control" name="password" placeholder="Enter Department" >
