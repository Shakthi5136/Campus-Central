...
<body>
<%String event=session.getAttribute("prevent").toString();
String orgmail=session.getAttribute("prorgmail").toString();
String clg=session.getAttribute("prclg").toString();
String eventtype=session.getAttribute("preventtype").toString();
String dept=session.getAttribute("prdept").toString();
...
<div class="container">
        <h2>Prize Details</h2>
        <form action="prizeadd" method="post" onsubmit="validateform()" enctype="multipart/form-data">
        Organizer Mail:
            <input class="input" type="text" name="orgmail" value="<%=orgmail%>" id="uname" placeholder="User Name"><br>
            <p id="u1" class="error"></p>Event Name
            <input class="input" type="text" name="eventname" value="<%=event%>" id="pass" placeholder="Enter Password"><br>
            <p id="u2" class="error"></p>College Name:
            <input class="input" type="text" name="clgmail" value="<%=clg%>" id="pass" placeholder="Enter Password"><br>
            <p id="u2" class="error"></p>Event Type:
            <input class="input" type="text" name="eventtype" value="<%=eventtype%>" id="pass" placeholder="Enter Password"><br>
            <p id="u2" class="error"></p>Department:
            <input class="input" type="text" name="departemnt" value="<%=dept%>" id="pass" placeholder="Enter Password"><br>
