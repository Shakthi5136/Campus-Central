...
<%String staff=session.getAttribute("stafid").toString(); %>
<%
...
<div>
<center><br><br>
<form action="staffprojmark.jsp" method="post">
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="staffid" value="<%=staff%>" id="exampleFormControlInput1" placeholder="staff id" style="width:200px;"required>
</div>
