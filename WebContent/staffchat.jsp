  ...
  <thead>
    <tr>
      ...
      <th scope="col">STAFF NAME</th>
       ...
       con=dbcon.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `college`.`chat` where stuid='"+stid+"' and status1='' and status2='staff' ");
...
<td><p class="card-text"><%=rs.getString(2)%></p></td>
       ...
       <td><a href="chatstudent.jsp?id=<%=rs.getString(1)%>&&sta=<%=rs.getString(2)%>&&stu=<%=rs.getString(3)%>"> Chat<i class='fa fa-trash-alt'></i></a></td>
