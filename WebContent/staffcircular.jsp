...
<table class="table table-bordered">
  <thead>
    <tr>
      ...
      <th scope="col">ID</th>
      <th scope="col">ABOUT CIRCULAR</th>
       ...
       con=dbcon.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `college`.`staffcircular` where depart='"+dept+"' ");
...
<td><p class="card-text"><%=rs.getString(2)%></p></td>
       ...
       <td><a href="circularviewsentbystaff.jsp?id=<%=rs.getString(3)%>&&nom=2"> View<i class='fa fa-trash-alt'></i></a></td>
