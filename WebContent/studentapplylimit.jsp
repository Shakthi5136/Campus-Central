...
<body>
<div class="container">
  <form name="sign up form" class="myForm" onsubmit="success()" action="limiteventapply" method="post" enctype="multipart/form-data">
    <br>
    <br>
    <br>
...
<div class="caption">Select Your Gender</div>
  ...
  <div class="caption">Enter Password</div>
    ...
    <br>
    <br> 
     <div class="caption">Limited Token:</div>
    <input type="text" class="input"  id="email" value="<%=cad%>" name="degree"  placeholder="Degree">
    <br><br>
   ...
   <input type="submit"  style="padding:10px;margin-left:140px;">
...
<script>
function success(){
	alert("You have been applied successfully and Wait for the conformation from college.....")
