...
<div class="body"></div>
		...
		<br>
		<%String a=session.getAttribute("clg").toString(); %>
			<div class="login">
<input type="text" name="username" placeholder="STUDENT NAME "><br><br>
<input type="text" name="college" value="<%=a %>" placeholder="STUDENT COLLEGE "><br><br>
...
<input type="password" name="password1" placeholder="STUDENTY ID" id="password1" ><br><br>

<input type="password" name="password2" placeholder="DEPARTMENT" id="password2" onchange="validatepassword()"><br><br>
