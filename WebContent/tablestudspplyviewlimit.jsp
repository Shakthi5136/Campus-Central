  ...
  <table class="table  table-hover">
    <thead>
     ...
     <%
       ...
       con=Dbconn.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `collegeevent`.`freeapplyevent` where eventname='limit' and status='Not Approved'   ");
    ...
    <tbody>
      ...
      <td><%=rs.getString(1)%></td>
        ...
        <td><a href="studapplyview.jsp"><button class="btn btn-primary">Make Appointment</button></a>
      </tr>
    </tbody>
    	<%} %>
  </table>
