 ...
 */
@WebServlet("/limiteventapply")
public class limiteventapply extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public limiteventapply() {
        super();
...
MultipartParser mp =new MultipartParser(request, 999999999);
	...
	//file encrypted and store into filepath1
             ...
             filepath1 = editpath + "\\college\\WebContent\\Encrypt\\"+filename;
              ...
              //file decrypted and store into filepath2
        		    ...
        		    filepath2 = editpath + "\\college\\WebContent\\Decrypt\\"+filename;
     ...
     filepath1 = editpath + "\\college\\WebContent\\Encrypt\\"+filename;
      ...
      //file decrypted and store into filepath2
        ...
        up.setPass(paramValues.get(20).toString());
        System.out.println("des: "+paramValues.get(20));
        
        up.setCpass(paramValues.get(22).toString());
        System.out.println("des: "+paramValues.get(22));
        
        up.setHoppy(paramValues.get(24).toString());
        System.out.println("des: "+paramValues.get(24));
        
        up.setEventname(paramValues.get(26).toString());
        System.out.println("des: "+paramValues.get(26));
        
        up.setEventlimit(paramValues.get(28).toString());
        System.out.println("des: "+paramValues.get(28));
        
        up.setEventtype(paramValues.get(30).toString());
        System.out.println("des: "+paramValues.get(30));
       
        up.setOrgrn(paramValues.get(32).toString());
        System.out.println("des: "+paramValues.get(32));
        
        up.setSdate(paramValues.get(34).toString());
        System.out.println("des: "+paramValues.get(34));
